	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="index.jsp"><i
					class="fa-solid fa-house-heart"></i> Home<span class="sr-only">(current)</span></a>
			</li>

			<c:if test="${userobj.role eq 'admin'}">
				<li class="nav-item"><a class="nav-link" href="add_job.jsp"><i
						class="fa-solid fa-square-plus"></i> Post Job</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			<c:if test="${userobj.role eq 'admin' }">
				...
				<a href="logout" class="btn btn-light"><i
					class="fa-solid fa-arrow-right-from-bracket mr-0.2"></i>Logout</a>
			</c:if>
			...
			<c:if test="${empty userobj }">
				<a href="login.jsp" class="btn btn-light mr-1"><i
					class="fa-solid fa-arrow-right-from-bracket mr-0.2"></i>Login</a>
				...
				<div class="card">
					<div class="card-body">
						<div class="text-center text-primary">
							<i class="fos fo-user-circle fa-3x"></i>
						</div>
						<table class="table">
							<tbody>
								<tr>
